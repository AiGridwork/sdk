...
> Python client SDK for interacting with the core inference API - part of the [AiGridwork](https://github.com/AiGridwork) open-source ecosystem.
...
The `sdk` package provides the Python interface for integrating with AiGridwork's infrastructure, designed for ease of use in both scripts and production services.
...
```bash
git clone https://github.com/AiGridwork/sdk
cd sdk
pip install -e .
```
...
- **GitHub Issues:** [github.com/AiGridwork/issues](https://github.com/AiGridwork)
- **Discussions:** [github.com/AiGridwork/discussions](https://github.com/AiGridwork)
